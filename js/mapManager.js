...
class MapManager {
    ...
    loadAPI() {
        ...
        script.src = `https://maps.googleapis.com/maps/api/js?key=${this.apiKey}&loading=async&callback=${this.callbackName}`;
    ...
    addMarkers(markers) {
        ...
        markers.forEach(markerData => {
            ...
            const contentString = `<div><h1>${markerData.name}</h1></div>`;
